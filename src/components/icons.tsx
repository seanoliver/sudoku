...
export type IconName = 'clock' | 'filter' | 'restart' | 'shield' | 'sparkles' | 'focus' | 'fill' | 'undo' | 'erase' | 'pencil' | 'pause' | 'play' | 'plus' | 'chevron' | 'settings' | 'download' | 'check' | 'close' | 'help' | 'sun' | 'moon' | 'numbers' | 'exclude' | 'bulb' | 'learn';
const paths: Record<IconName, React.ReactNode> = {
  ...
  learn: <><path d="M12 7v13M12 7a3 3 0 0 0-3-3H3v14h6a3 3 0 0 1 3 3M12 7a3 3 0 0 1 3-3h6v14h-6a3 3 0 0 0-3 3"/></>,
