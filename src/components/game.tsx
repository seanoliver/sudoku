...
export default function SudokuGame() {
  ...
  const input = (value: number) => {
    ...
    if (batchSelection) {
      ...
      setGame(current => current ? applyBatch(current, { indices: selection.indices, value, filterNumberKeys: preferences.filterNumberKeys }) : current);
      clearSelection();
    } else {
