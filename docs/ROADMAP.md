...
**Status:** Implemented on `feat/unit-celebrations` ([design](plans/2026-09-23-unit-celebrations-design.md)). A pale green sweep ripples from the entered cell across each newly completed row, column and box; the final entry sweeps the whole board.
